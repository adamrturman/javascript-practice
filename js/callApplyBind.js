...
//	call is used for function arguments (think comma-separated = C for .call)
...
//	apply is used for array values (think array = A for .apply)
...
console.log(bound(1,2,3));	//	now the function is called with the provided args and returns 8 
...
console.log("How old was I in 1993, 1997 and 2016?", agesOnEvent.call(person1, 1993, 1997, 2016))   //  returns [5, 9, 28]
